...
declare type EEmscriptenProfilerMode = 'None' | 'CPU' | 'Memory' | 'Thread' | 'EEmscriptenProfilerMode_MAX';
declare var EEmscriptenProfilerMode : { None:'None',CPU:'CPU',Memory:'Memory',Thread:'Thread',EEmscriptenProfilerMode_MAX:'EEmscriptenProfilerMode_MAX', };
...
declare class HTML5TargetSettings extends UObject { 
	...
	SessionStorageCommandLineKey: string;
	SessionStorageWebSocketUrlKey: string;
	EnableTracing: boolean;
	EmscriptenProfilerMode: EEmscriptenProfilerMode;
	bRequestPointerlockBeforeFullscreen: boolean;
	BackgroundCssStyle: string;
	bIconsOnlyToolbar: boolean;
	bTransparentToolbar: boolean;
	bOverlayToolbar: boolean;
	bShowPauseResumeButton: boolean;
	bShowClearIndexedDBButton: boolean;
	bShowFullscreenButton: boolean;
	PauseButtonText: string;
	ResumeButtonText: string;
	ClearIndexedDBButtonText: string;
